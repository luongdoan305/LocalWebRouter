...
export const WanSettings1 = (props: any) => {
    ...
    const refreshData = async () => {
        ...
        const {ifname, link_type, gateway, ipaddr, netmask, proto, username, password, timeout } = result['wan1'][0]['values']
    ...
    const handleSubmit = async (values: any) => {
        ...
        const result = await ubusApi.config_network_wan(values.status, values.ifname, "wan1", values.link_type, values.protov4, values.username, values.password, values.timeout, values.ipaddrv4, values.netmaskv4, values.gtwv4, values.protov6, values.ipaddrv6, values.gtwv6)     
    ...
    return (
        ...
        <Form form={form}
            ...
            >
            <Card title="Config WAN1 Settings" loading={loading} headStyle={{background:"linear-gradient(113deg, rgba(32,162,145,1) 0%, rgba(18,207,141,1) 30%)",color: 'white'}} >
